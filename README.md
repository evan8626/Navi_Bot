...
navi_bot
    ...
    utils
        ...
        |
        ---- websocket.py - sets up websocket server to send data to front end
    |
...
telemetry_dashboard
    |
    ---- index.html - front end for the telemetry dashboard. Has 2 tabs, the first is live telemetry data, the second is a tests tab that allows a user to run tests
    |
    ---- main.js - reads data generated by tests/live streaming
    |
    ---- preload.js - sets up buttons backend for dashboard navigation
tests
    |
